...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<ObjetoErro> objetoNaoEncontradoException (ObjetoNaoEncontradoException e, HttpServletRequest request){
        ObjetoErro erro = new ObjetoErro(HttpStatus.NOT_FOUND.value(),e.getMessage(),System.currentTimeMillis(),request.getRequestURI());
    ...
    public ResponseEntity<ObjetoErro> operacaoNaoRealizadaException (OperacaoNaoRealizadaException e, HttpServletRequest request){
        ObjetoErro erro =  new ObjetoErro(HttpStatus.BAD_REQUEST.value(),e.getMessage(),System.currentTimeMillis(),request.getRequestURI());
    ...
    public ResponseEntity<ObjetoDeValidacao> erroDeValidacaoException(MethodArgumentNotValidException e, HttpServletRequest request){
        ObjetoDeValidacao erro = new ObjetoDeValidacao(HttpStatus.UNPROCESSABLE_ENTITY.value(), Mensagens.MSG_VALIDACAO_CAMPO,System.currentTimeMillis(),request.getRequestURI());
    ...
    public ResponseEntity<ObjetoErro> emailNaoEnviadoException(EmailNaoEnviadoException e, HttpServletRequest request){
        ObjetoErro erro = new ObjetoErro(HttpStatus.INTERNAL_SERVER_ERROR.value(), e.getMessage(),System.currentTimeMillis(),request.getRequestURI());
    ...
    public ResponseEntity<ObjetoErro> falhaNoProcessoDeAutenticacao(FalhaNoProcessoDeAutenticacao e, HttpServletRequest request){
        ObjetoErro erro = new ObjetoErro(HttpStatus.UNAUTHORIZED.value(), e.getMessage(),System.currentTimeMillis(),request.getRequestURI());
    ...
    public ResponseEntity<ObjetoErro> operacaoNaoAutorizada(OperacaoNaoAutorizadaException e, HttpServletRequest request){
        ObjetoErro erro = new ObjetoErro(HttpStatus.FORBIDDEN.value(), e.getMessage(), System.currentTimeMillis(),request.getRequestURI());
